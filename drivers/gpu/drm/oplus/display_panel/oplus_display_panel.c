...
static const struct panel_ioctl_desc panel_ioctls[] = {
	...
	PANEL_IOCTL_DEF(PANEL_IOCTL_SET_OPPO_BRIGHTNESS, oplus_display_set_brightness),
	PANEL_IOCTL_DEF(PANEL_IOCTL_GET_OPPO_BRIGHTNESS, oplus_display_get_brightness),
