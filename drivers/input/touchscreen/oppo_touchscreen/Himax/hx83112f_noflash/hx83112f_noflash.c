...
void himax_read_OPPO_FW_ver(struct chip_data_hx83112f *chip_info)
{
    uint8_t cmd[4];
    uint8_t data[4];
                         ...
                         char *g_project_test_info_log, char *rslt_buf, char *filepath)
{
    ...
    char *line = "=================================================\n";
    char *Company = "Himax for OPPO: Driver Seneor Test\n";
    char *Info = "Test Info as follow\n";
    char *project_name_log = "OPPO_";
    mm_segment_t fs;
    loff_t pos = 0;
    int ret_val = NO_ERR;
...
static struct oppo_touchpanel_operations hx83112f_ops = {
