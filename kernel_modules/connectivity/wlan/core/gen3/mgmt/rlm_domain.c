...
static const UINT_16 g_u2CountryGroup6[] = { COUNTRY_CODE_RU };
...
static const UINT_16 g_u2CountryGroup8[] = { COUNTRY_CODE_MY };

static const UINT_16 g_u2CountryGroup9[] = { COUNTRY_CODE_NP };
...
static const UINT_16 g_u2CountryGroup11[] = {
	COUNTRY_CODE_JO, COUNTRY_CODE_PG
};

static const UINT_16 g_u2CountryGroup12[] = { COUNTRY_CODE_AF };

static const UINT_16 g_u2CountryGroup13[] = { COUNTRY_CODE_NG };
...
static const UINT_16 g_u2CountryGroup15[] = { COUNTRY_CODE_ID };
...
static const UINT_16 g_u2CountryGroup17[] = {
	COUNTRY_CODE_US, COUNTRY_CODE_CA, COUNTRY_CODE_TW
};

static const UINT_16 g_u2CountryGroup18[] = {
...
static const uint16_t g_u2CountryGroup3[] = {
	...
	COUNTRY_CODE_KE, COUNTRY_CODE_MX, COUNTRY_CODE_TH,
...
static const uint16_t g_u2CountryGroup5[] = {
	...
	COUNTRY_CODE_PE, COUNTRY_CODE_UY, COUNTRY_CODE_NZ
};

static const uint16_t g_u2CountryGroup6[] = { COUNTRY_CODE_RU };

static const uint16_t g_u2CountryGroup7[] = {
	COUNTRY_CODE_CL, COUNTRY_CODE_AG, COUNTRY_CODE_IN,
	COUNTRY_CODE_BS, COUNTRY_CODE_BH, COUNTRY_CODE_BB, COUNTRY_CODE_BN,
	COUNTRY_CODE_MV, COUNTRY_CODE_PA, COUNTRY_CODE_ZM, COUNTRY_CODE_CN,
	COUNTRY_CODE_NP
};
...
DOMAIN_INFO_ENTRY arSupportedRegDomains_Passive[] = {
	{
	 /* Default passive scan channel table:
	  *   5GHz -> UNII_MID(UNII-2A) and UNII_WW(UNII-2C) set to passive scan
	  */
	 NULL, 0,
	 {
