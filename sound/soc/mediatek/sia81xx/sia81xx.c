...
static int sia81xx_probe(struct platform_device *pdev)
{
    ...
    if((1 == sia_boost_vol) && (sia81xx->chip_type == CHIP_TYPE_SIA8109)) {
        soc_codec_dev_sia81xx.component_driver.controls = sia81xx_controls_new;
        soc_codec_dev_sia81xx.component_driver.num_controls = ARRAY_SIZE(sia81xx_controls_new);
